...
function TestSet(){
    return(
        <div id="testSetting">
            <Header/>
            <TestHead NextToTimer={SetSelections}/>
            <article>
                <div className="index-par">
                    <h2>시험을 시작하기 전!</h2>
                    <ol> 
                        <li><span className="marker">단어입력 창에서 단어들을 입력</span>하고 제출합니다. </li>
                        <li>시험을 위한 <span className="marker">시간, 문제수, 방식을 정해줍니다.</span>
                            <ul> 
                ...
                <div className="index-par">
                    <h2>시험 전 시험방법 숙지!</h2>
                    <ul> 
                        <li>답을 입력하는 시간을 제외하고는 <span className="marker">check가 써있는 사각버튼에 마우스를 올려두어야&#40;스마트폰의 경우 누르고 있어야&#41; 합니다.</span></li>
                        <li>check를 누르지 않은 상태가 5초 지나면 시험결과에 기록됩니다. &#40;이 경우 치팅의 가능성이 있으니 확인해주세요.&#41;.</li>
                        <li>단어입력단계에서 입력한 <span className="marker">단어의 의미가 여러개일 경우, 하나만 써야</span> 답으로 인정됩니다.</li>
