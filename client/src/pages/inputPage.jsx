...
import {
  ...
  handle_input,
  handle_reload,
} from "../javascripts/getWordInput.jsx";
      ...
      <div className="padding_all">
        <div className="grid-container">
          <article>
            <div id="how_to">
              ...
              <ul>
                <li>
                  단어를{" "}
                  <span className="marker">영어 + &amp;&amp; + 뜻 형식</span>
                  으로 적어주세요.
                </li>
                <li>
                  한 단어의{" "}
                  <span className="marker">
                    뜻이 여러 개라면 컴마&#40;,&#41;로 띄어쓰기 없이 구분해서
                  </span>{" "}
                  입력해주세요.
                  <br />
                  뜻이 여러 개라면 시험을 볼 때 랜덤으로 뜻을 제시하거나 답으로
                  받습니다.
                </li>
          ...
          <form id="words_input">
            ...
            <button
              type="button"
              onClick={() => handle_input(input_area, setwords)}
            >
              입력완료
            </button>
          </form>
        ...
        <button
          id="re_load"
          type="button"
          onClick={() => handle_reload(setwords)}
        >
          새로고침
        </button>
